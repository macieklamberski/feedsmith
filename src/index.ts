...
export type { Transcripts } from './related/transcripts/common/types.js'
export { detect as detectTranscripts } from './related/transcripts/detect/index.js'
export { generate as generateTranscripts } from './related/transcripts/generate/index.js'
export { parse as parseTranscripts } from './related/transcripts/parse/index.js'
