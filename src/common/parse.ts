...
import { detect as detectRdfFeed } from '../feeds/rdf/detect/index'
import { parse as parseRdfFeed } from '../feeds/rdf/parse/index'
import type { Feed as RdfFeed } from '../feeds/rdf/parse/types'
