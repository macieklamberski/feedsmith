...
describe('retrieveItemOrFeed', () => {
  ...
  it('should parse complete item or feed object with all properties (with array of values)', () => {
    ...
    const expected = {
      ...
      available: ['2023-06-01T00:00:00Z', '2023-07-01T00:00:00Z'],
      bibliographicCitations: [
        'Doe, J. (2023). Sample Work. Publisher.',
        'Smith, J. (2023). Another Work.',
      ],
      conformsTo: ['Dublin Core Metadata Terms', 'ISO Standard'],
      contributors: ['Jane Smith', 'Bob Johnson'],
      coverages: ['Global', 'Europe'],
      created: ['2023-05-01T12:00:00Z', '2023-05-02T12:00:00Z'],
      creators: ['John Doe', 'Jane Doe'],
      dateAccepted: ['2023-05-10T09:00:00Z', '2023-05-11T09:00:00Z'],
      dateCopyrighted: ['2023-05-15T00:00:00Z', '2023-05-16T00:00:00Z'],
      dates: ['2023-05-02T08:30:00Z', '2023-05-03T08:30:00Z'],
      dateSubmitted: ['2023-05-05T14:30:00Z', '2023-05-06T14:30:00Z'],
      ...
      isFormatOf: ['https://example.org/original', 'https://example.org/another-original'],
      isPartOf: ['https://example.org/collection', 'https://example.org/series'],
      isReferencedBy: [
        'https://example.org/references/citation1',
        'https://example.org/references/citation2',
      ],
      isReplacedBy: ['https://example.org/replacement', 'https://example.org/new-replacement'],
      isRequiredBy: ['https://example.org/dependent', 'https://example.org/another-dependent'],
      issued: ['2023-05-20T10:00:00Z', '2023-05-21T10:00:00Z'],
      isVersionOf: ['https://example.org/original-work', 'https://example.org/base-work'],
      languages: ['en-US', 'en-GB'],
      licenses: ['Creative Commons Attribution 4.0', 'MIT License'],
      mediators: ['Library System', 'Archive System'],
      mediums: ['Digital', 'Print'],
      modified: ['2023-05-25T16:45:00Z', '2023-05-26T16:45:00Z'],
      ...
      types: ['Text', 'Dataset'],
      valid: ['2024-05-25T23:59:59Z', '2025-05-25T23:59:59Z'],
    }
  ...
  it('should handle array of values and extract all', () => {
    const value = {
  ...
  it('should parse itemOrFeed with multiple values in arrays', () => {
    const value = {
      'dcterms:abstract': ['First abstract', 'Second abstract'],
      'dcterms:creator': ['John Doe', 'Jane Smith'],
      'dcterms:date': ['2023-01-01T00:00:00Z', '2023-02-01T00:00:00Z'],
      'dcterms:license': ['MIT', 'Apache 2.0'],
      'dcterms:created': ['2023-01-15T00:00:00Z', '2023-01-16T00:00:00Z'],
    }
    const expected = {
      abstracts: ['First abstract', 'Second abstract'],
      created: ['2023-01-15T00:00:00Z', '2023-01-16T00:00:00Z'],
