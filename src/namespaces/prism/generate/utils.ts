...
export const generateFeed: GenerateUtil<PrismNs.Feed<DateLike>> = (feed) => {
  ...
  const value = {
    ...
    'prism:publicationDate': generateRfc3339Date(feed.publicationDate),
    'prism:publicationDisplayDate': generateCdataString(feed.publicationDisplayDate),
    ...
    'prism:section': trimArray(feed.sections, generateCdataString),
    ...
    'prism:sellingAgency': generateCdataString(feed.sellingAgency),
    ...
    'prism:platform': generateCdataString(feed.platform),
    ...
    'prism:url': generateCdataString(feed.url),
    'prism:byteCount': generateNumber(feed.byteCount),
    'prism:rating': trimArray(feed.ratings, generateCdataString),
    'prism:timePeriod': trimArray(feed.timePeriods, generateCdataString),
    ...
    'prism:profession': trimArray(feed.professions, generateCdataString),
    'prism:sport': trimArray(feed.sports, generateCdataString),
...
export const generateItem: GenerateUtil<PrismNs.Item<DateLike>> = (item) => {
  ...
  const value = {
    ...
    'prism:url': generateCdataString(item.url),
    ...
    'prism:section': trimArray(item.sections, generateCdataString),
    ...
    'prism:publicationDate': generateRfc3339Date(item.publicationDate),
    ...
    'prism:teaser': generateCdataString(item.teaser),
    ...
    'prism:platform': generateCdataString(item.platform),
    ...
    'prism:profession': trimArray(item.professions, generateCdataString),
    'prism:sport': trimArray(item.sports, generateCdataString),
    ...
    'prism:supplementTitle': generateCdataString(item.supplementTitle),
