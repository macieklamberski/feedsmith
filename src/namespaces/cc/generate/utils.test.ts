...
describe('generateItemOrFeed', () => {
  ...
  it('should generate item with only license', () => {
    const value = {
  ...
  it('should generate item with only morePermissions', () => {
    const value = {
...
describe('generateItemOrFeed', () => {
  ...
  it('should generate feed with only license', () => {
    const value = {
      license: 'https://creativecommons.org/licenses/by/4.0/',
    }
    const expected = {
  ...
  it('should generate feed with only morePermissions', () => {
    const value = {
      morePermissions: 'https://example.com/additional-permissions',
    }
    const expected = {
