  ...
  describe('real world feeds', () => {
    ...
    describe('content handling', () => {
      ...
      it('RW-D20: should decode entity-encoded markup in type="text" title', () => {
        ...
        `
        const expected = {
          title: { type: 'text', value: '<b>Bold Title</b>' },
          id: 'urn:uuid:test',
          updated: '2024-01-01T00:00:00Z',
        }
    ...
    describe('namespace edge cases', () => {
      it('RW-Q01: should parse YouTube feed with yt namespace', () => {
        ...
        expect(result.title).toEqual({ value: 'YouTube Channel' })
          ...
          entries: [
            {
              ...
              id: 'urn:uuid:1',
              updated: '2024-01-01T00:00:00Z',
              content: { type: 'html', value: '<p>Hello <strong>world</strong></p>' },
            },
          ],
        }
